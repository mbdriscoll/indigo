...
parser.add_argument('--tree_passes', help='number of realization passes: --tree_passes:1,2')
parser.add_argument('--realize_passes', help='number of realization passes: --realize_passes:1,2')
parser.add_argument('--operator_passes', help='number of realization passes: --operator_passes:1,2')
...
treePasses = [int(x) for x in args.tree_passes.split(',')]
realizePasses = [int(x) for x in args.realize_passes.split(',')]
operatorPasses = [int(x) for x in args.operator_passes.split(',')]
...
for t in range(numTrees):
    for treePass in treePasses:
        for realizePass in realizePasses:
            for operatorPass in operatorPasses:
                # set up logging
                ...
                passes = {'tree': treePass, 'realize': realizePass, 'operator': operatorPass}
